...
export default function GleefixPlatformPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F7F9FC] overflow-hidden">
      ...
      <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10 text-sm font-semibold text-slate-600">
            ...
            <button className="text-[#0F2B46]">Platform</button>
      ...
      {/* DASHBOARD PREVIEW */}
      <section className="bg-white border-y border-slate-200 py-24 px-6 overflow-hidden">
            ...
            <div className="grid lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 rounded-4xl bg-white p-6 border border-white/10">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button className="h-11 px-5 rounded-xl bg-slate-100 text-slate-700 font-semibold">
                    This Month
                  </button>
                </div>
